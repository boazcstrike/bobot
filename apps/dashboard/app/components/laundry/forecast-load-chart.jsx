 ...
 * count per category (recency-weighted trend, see lib/laundryLoadForecast).
 * Stacked bars — top categories plus an "Other" bucket. Heights vary by day
 * because each category carries its own trend.
 */
export default function ForecastLoadChart({ loadForecast }) {
